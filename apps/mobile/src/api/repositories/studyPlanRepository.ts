...
const mockPlan: StudyPlanData = {
  ...
  recommendationReason:
    'গত সপ্তাহে বীজগণিত সরল সমীকরণে কিছু ভুল হয়েছিল। আজ ১০ মিনিট এই বিষয়টি ঝালাই করো।',
  tasks: [
    {
      id: 't1',
      title: 'বিজ্ঞান: সালোকসংশ্লেষণ পাঠ রিভিশন',
      subject: 'বিজ্ঞান',
      durationMinutes: 10,
      completed: true,
    },
    {
      id: 't2',
      title: 'গণিত: সরল সমীকরণ প্র্যাকটিস সেসশ',
      subject: 'গণিত',
      durationMinutes: 10,
      completed: false,
    },
    {
      id: 't3',
      title: 'ইংরেজি: Vocabulary 10 Words',
      subject: 'ইংরেজি',
      durationMinutes: 5,
      completed: false,
    },
