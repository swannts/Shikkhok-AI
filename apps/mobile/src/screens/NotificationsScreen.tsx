...
export const NotificationsScreen: React.FC<NotificationsScreenProps> = ({ onBack }) => {
  const notifs = [
    { id: '1', title: 'দৈনিক কুইজ রিমাইন্ডার 🔔', time: '১০ মিনিট আগে', desc: 'আজকের বীজগণিত প্র্যাকটিস এখনো বাকি!' },
    { id: '2', title: 'নতুন অধ্যায় যোগ হয়েছে 📚', time: '২ ঘণ্টা আগে', desc: 'বিজ্ঞান: মহাবিশ্ব ও সৌরজগত পাঠ তৈরি।' },
    { id: '3', title: 'সাপ্তাহিক রিপোর্ট তৈরি 📊', time: 'গতকাল', desc: 'তোমার অভিভাবক ড্যাশবোর্ডে নতুন পারফরম্যান্স আপডেট।' },
  ];
