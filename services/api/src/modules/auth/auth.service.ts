...
import { SignupInput, LoginInput, VerifyOtpInput } from './auth.schemas';
...
// In-memory fallback TTL store for Redis in local dev
...
export class AuthService {
  ...
  async signup(input: SignupInput) {
    ...
    const rawOtp = '123456'; // Production SMS gateway would send real 6-digit OTP
